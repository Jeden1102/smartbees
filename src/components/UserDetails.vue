<template>
    <div class="flex flex-col">
        ...
        <div class="flex items-center  space-x-2">
            <input v-model="newAccount" class="h-4 w-4 text-red-600 focus:ring-red-500 p-1 border-gray-300 rounded" id="newAccount" type="checkbox">
        ...
        <form class="w-full" action="">
            ...
            <div class="flex items-center  space-x-2">
                <input  v-model="newAddress" class="h-4 w-4 text-red-600 focus:ring-red-500 p-1 border-gray-300 rounded" id="otherAdress" type="checkbox">
                <label for="otherAdress">Dostawa pod inny adres</label>
            </div>
            <Transition name="bounce">
            <div v-if="newAddress" class="newAddress">
